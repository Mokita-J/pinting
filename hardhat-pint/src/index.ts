...
task("clean", "Removes the Pint compiled contracts directory").setAction(
  async function (_, { config }) {
    const pint = new Pint();
...
task(
  "node",
  "Run Essential node, you can specify the Node API and Builder API bind addresses"
)
  .addOptionalParam(
    "nodeApiBindAddress",
